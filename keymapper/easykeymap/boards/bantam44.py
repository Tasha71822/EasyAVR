...
"""Keyboard definition for the handwired Bantam 44 keyboard"""
...
keyboard_definition = [
    [((4, 4), (0, 0), 'HID_KEYBOARD_SC_ESCAPE'),
     ...
     ((4, 4), (0, 11), 'HID_KEYBOARD_SC_DELETE')],
    ...
    [((6, 4), (1, 0), 'HID_KEYBOARD_SC_TAB'),
     ...
     ((6, 4), (1, 11), 'HID_KEYBOARD_SC_ENTER')],

    [((4, 4), (2, 0), 'HID_KEYBOARD_SC_CAPS_LOCK'),
     ((4, 4), (2, 1), 'HID_KEYBOARD_SC_LEFT_SHIFT'),
     ((4, 4), (2, 2), 'HID_KEYBOARD_SC_Z'),
     ((4, 4), (2, 3), 'HID_KEYBOARD_SC_X'),
     ((4, 4), (2, 4), 'HID_KEYBOARD_SC_C'),
     ((4, 4), (2, 5), 'HID_KEYBOARD_SC_V'),
     ((4, 4), (2, 6), 'HID_KEYBOARD_SC_B'),
     ((4, 4), (2, 7), 'HID_KEYBOARD_SC_N'),
     ((4, 4), (2, 8), 'HID_KEYBOARD_SC_M'),
     ((4, 4), (2, 9), 'HID_KEYBOARD_SC_COMMA_AND_LESS_THAN_SIGN'),
     ((4, 4), (2, 10), 'HID_KEYBOARD_SC_DOT_AND_GREATER_THAN_SIGN'),
     ((4, 4), (2, 11), 'HID_KEYBOARD_SC_RIGHT_SHIFT')],

    [((5, 4),  (3, 0), 'HID_KEYBOARD_SC_LEFT_CONTROL'),
     ((5, 4),  (3, 1), 'HID_KEYBOARD_SC_LEFT_ALT'),
     ((5, 4),  (3, 2), 'HID_KEYBOARD_SC_LEFT_GUI'),
     ((5, 4),  (3, 3), 'SCANCODE_FN'),
     ((11, 4), (3, 5), 'HID_KEYBOARD_SC_SPACE'),
     ((5, 4),  (3, 7), 'SCANCODE_FN2'),
     ((4, 4),  (3, 9), 'HID_KEYBOARD_SC_SEMICOLON_AND_COLON'),
